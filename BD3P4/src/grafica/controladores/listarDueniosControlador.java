...
public class listarDueniosControlador {
	...
	private listarDueniosVentana vent;

	public listarDueniosControlador(listarDueniosVentana window)throws SQLException, ConectionException, FileNotFoundException, NotBoundException, IOException
	{
